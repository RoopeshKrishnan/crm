                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="" name="category" id="category" placeholder="E-commerce">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-sm text-center">
                                                    <a href="#" id="edit_category" class="mx-3" value="<?= $row->category_id  ?>" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit product">
                                                        <i class="fas fa-user-edit text-dark"></i>
                                                    </a>
                                                    <a href="#" id="delete_category" class="mx-3" value="<?= $row->category_id  ?>" data-bs-toggle="tooltip" data-bs-original-title="Delete product">
