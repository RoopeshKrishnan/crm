      ...
      <div class="card card-profile">
        ...
        <div class="card-body pt-0">
          <div class="text-center mt-4">
            <h5>
            <?= $user_details->user_name ?><span class="font-weight-light">, <?= $age ?></span>
            </h5>
            <div class="h6 font-weight-300">
              <i class="ni location_pin mr-2"></i><?= $personal_details->user_address ?>
            </div>
            <div class="h6 mt-4">
              <?php $fetch_des= $this->db->where('deleted',0)->where('designation_id',$employment_details->designation_id)->get('designation')->row(); 
              $designation = $fetch_des->designation ?>
              <i class="ni business_briefcase-24 mr-2"></i><?= $designation?>
            </div> 
          </div>
        </div>
      </div>
